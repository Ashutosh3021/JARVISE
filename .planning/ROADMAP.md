...
Plans:
- [ ] B-1-01-PLAN.md — LLM Response Fixes (prompt_builder + agent)
- [ ] B-1-02-PLAN.md — Tool Registry Fixes (brain/tools.py)
- [ ] B-1-03-PLAN.md — Logging + Router + Backend + Dependencies
...
| B-1. Core Chat Foundation | 0/3 | Planned     | 2026-03-22 |
